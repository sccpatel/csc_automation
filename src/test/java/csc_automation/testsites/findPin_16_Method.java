...
public class findPin_16_Method extends BaseClass {
	...
	public void check() {
		...
		obj.openCSCIDAndLogin(or.CSCid_16, or.cscPassword_16);
		obj.rechargeCSC(or.loopNo_16, "CSC id- 16", or.endLoopNo_16);
	}
